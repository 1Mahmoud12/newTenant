...
class ProductCategoryView extends StatefulWidget {
  ...
  @override
  State<ProductCategoryView> createState() => _ProdcutCategoryViewState();
}
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          if (ConstantsModels.categoriesModel?.data?.isNotEmpty ?? true)
            BlocProvider.value(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CustomList(
                          ...
                          tabs: List.generate(ConstantsModels.categoriesModel?.data?.length ?? 0, (index) {
                            return ConstantsModels.categoriesModel?.data![index].name ?? 'unKnow Category';
                          }),
                          onTabChanged: (index) {
                            topProductCubit.getTopProduct(
                              context: context,
                              subCategoryId: ConstantsModels.categoriesModel?.data![index].id,
                            );
                          },
                        ),
                      ),
                  ...
                  return Expanded(
                    child: Padding(
                      ...
                      child: GridView.builder(
                        itemCount: ConstantsModels.topProductModel?.data?.length ?? 0,
